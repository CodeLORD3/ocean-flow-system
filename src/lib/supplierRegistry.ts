...
export const SUPPLIER_REGISTRY: RegistryEntry[] = [
  ...
  {
    domain: "jhb.se",
    name: "Johan i Hallen & Bergfalk AB",
    country: "Sverige",
    website: "https://www.jhb.se",
    email: "order@jhb.se",
    supplier_type: "Färsk fisk",
    currency: "SEK",
    note: "Kött, fisk och delikatesser — kontrollera org.nr innan bokföring",
  },
  {
    domain: "kontorsgiganten.se",
    name: "Kontorsgiganten",
    country: "Sverige",
    website: "https://www.kontorsgiganten.se",
    email: "email@kontorsgiganten.se",
