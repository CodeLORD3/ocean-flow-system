...
/**
 * Senaste lageraktivitet per enhet — så man direkt ser om någon lagt in i
 * lager eller inventerat inom 24 timmar.
 */
export function useStoreStockActivity() {
  return useQuery({
    queryKey: ["store-stock-activity"],
    queryFn: async () => {
      ...
      const map = new Map<string, StoreStockActivity>();
