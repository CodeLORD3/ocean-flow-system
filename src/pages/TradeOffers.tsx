...
export default function TradeOffers() {
 ...
 inputMode="decimal" />
                <FormField label="Minimum Ticket (kr)" value={form.min_pledge} onChange={v => setForm({...form, min_pledge: v})} type="number"
 inputMode="decimal" placeholder="0" />
                <FormField label="Maximum Ticket (kr, valfri)" value={form.max_pledge} onChange={v => setForm({...form, max_pledge: v})} type="number"
 inputMode="decimal" placeholder="Ingen gräns" />
                <FormField label="Expected Return (%)" value={form.interest_rate} onChange={v => setForm({...form, interest_rate: v})} type="number"
 ...
 inputMode="decimal" />
                <FormField label="Gross Margin (%) — auto" value={form.gross_margin} onChange={v => setForm({...form, gross_margin: v})} type="number"
 inputMode="decimal" step="0.1" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <FormField label="LTV (%)" value={form.ltv} onChange={v => setForm({...form, ltv: v})} type="number"
 inputMode="decimal" step="0.1" />
