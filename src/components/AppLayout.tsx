...
const pageTitles: Record<string, { title: string; breadcrumb: string[] }> = {
  ...
  "/personal": { title: "Personal & Schema", breadcrumb: ["Hem", "Personal & Schema"] },
  "/staff": { title: "Personalhantering", breadcrumb: ["Hem", "Personal & Schema", "Personal"] },
  "/hr-control": { title: "Frånvaro & bemanning", breadcrumb: ["Hem", "Personal & Schema", "Frånvaro & bemanning"] },
  ...
  "/pos-fundament": { title: "POS-fundament", breadcrumb: ["Hem", "POS", "POS-fundament"] },
  "/pos-priser": { title: "POS-priser", breadcrumb: ["Hem", "POS", "POS-priser"] },
  ...
  "/establishments": { title: "Anläggningar", breadcrumb: ["Hem", "Anläggningar"] },
  "/legal-entities": { title: "Bolag", breadcrumb: ["Hem", "Bolag"] },
  "/food-safety": { title: "Egenkontroll", breadcrumb: ["Hem", "Egenkontroll"] },
