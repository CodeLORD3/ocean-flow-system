...
import { Bell, ChevronRight, Search, User, ArrowLeftRight, Factory, Store, ChevronDown, ShoppingBag } from "lucide-react";
  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen flex w-full">
        {site === "shop" ? <ShopSidebar /> : site === "production" ? <ProductionSidebar /> : site === "purchasing" ? <PurchasingSidebar /> : <AppSidebar />}
          ...
          <div className="h-8 flex items-center justify-between bg-sidebar-background px-4 text-xs text-sidebar-foreground/70 shrink-0">
            <div className="flex items-center gap-4">
              ...
              <span className="hidden sm:inline">
                {site === "shop" ? `Butik: ${activeStoreName || "–"}` : site === "production" ? "Produktion" : site === "purchasing" ? "Inköp" : "Grossist"}
              </span>
            </div>
