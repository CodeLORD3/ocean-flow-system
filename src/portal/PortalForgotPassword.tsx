    ...
    <div className="min-h-screen bg-[#f4f6f9] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          {sent ? (
            <div className="text-center">
              <div className="mx-auto w-12 h-12 bg-[#0f2e3d]/10 rounded-full flex items-center justify-center mb-4">
                <Mail className="h-6 w-6 text-[#0f2e3d]" />
              </div>
              <h1 className="text-xl font-bold text-[#0f2e3d] mb-2">Check your email</h1>
              ...
              <p className="text-xs text-gray-400">
                ...
                <button onClick={() => setSent(false)} className="text-[#0f2e3d] underline">try again</button>.
              </p>
            </div>
          ) : (
            <>
              <h1 className="text-xl font-bold text-[#0f2e3d] mb-1">Reset your password</h1>
        ...
        <p className="text-center text-xs text-gray-500 mt-4">
          <Link to="/portal/login" className="text-[#0f2e3d] font-medium hover:underline flex items-center justify-center gap-1">
